...
$(document).ready(function($) {
    ...
    currentDiv.waypoint({
      handler: function(direction) {
        if (direction === "down") {
          ...
          $(".navigate-section > li > a[href*=#" + containerID + "]").addClass(
            "active"
          );
        }
      },
  ...
  $.each(itemsPhotosContainer, function(key) {
    var numbOfItemsShowed =
      parseInt($(itemsPhotosContainer[key]).attr("data-item-showen"), 10) - 1;

    $(itemsPhotosContainer[key])
      .find(".item:gt(" + numbOfItemsShowed + ")")
      .css("display", "none");
